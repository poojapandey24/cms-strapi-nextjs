      ...
      <section className="py-16 px-6 max-w-7xl mx-auto space-y-16">
        ...
        <div className="flex flex-col md:flex-row items-center gap-10">
          <div className="md:w-1/2">
            ...
            <p className="text-white/80">
              ...
              customers with tools like ticketing and live chat. CRM includes a
              universal inbox, giving your whole team a centralized view of
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-10">
          <div className="md:w-1/2">
            ...
            <p className="text-white/80">
              Close more deals, faster with our AI-powered deal management tools
              that streamline your sales process, so your leads move seamlessly
              from qualified to closed-won. Introduce consistency into the
              customer journey and arm your sellers with all the data and
              insights they need to prioritize the right deals at the right
              time.
            </p>
          </div>
          <div className="md:w-1/2">
        ...
        <div className="flex flex-col md:flex-row items-center gap-10">
          <div className="md:w-1/2">
            ...
            <p className="text-white/80">
              Identify high-value leads with data-driven prospecting tools. Use
              real-time insights and engagement tracking to focus on the leads
              that matter most.
            </p>
          </div>
          <div className="md:w-1/2">
